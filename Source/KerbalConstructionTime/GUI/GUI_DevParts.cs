...
namespace KerbalConstructionTime
{
    public static partial class KCT_GUI
    {
        ...
        internal static void InitDevPartsToggle()
        {
            ...
            ToolbarControl.LoadImageFromFile(ref _devPartsOnTex, KSPUtil.ApplicationRootPath + "GameData/LRTR/KCT/icons/KCT_dev_parts_on");
            ToolbarControl.LoadImageFromFile(ref _devPartsOffTex, KSPUtil.ApplicationRootPath + "GameData/LRTR/KCT/icons/KCT_dev_parts_off");
