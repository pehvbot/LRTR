...
namespace KerbalConstructionTime
{
    public static partial class KCT_GUI
    {
        ...
        private static bool _disableAllMsgs, _showSimWatermark, _debug, _overrideLaunchBtn, _autoAlarms, _autoStockAlarms, _cleanUpKSCDebris;
        ...
        public static void DrawPresetWindow(int windowID)
        {
            ...
            if (GUILayout.Button("Save", GUILayout.ExpandWidth(false)))
            {
                ...
                KCTGameStates.Settings.AutoStockAlarms = _autoStockAlarms;
            ...
            _autoStockAlarms = GUILayout.Toggle(_autoStockAlarms, "Auto Stock Alarms", HighLogic.Skin.button);
        ...
        public static void DrawPresetSaveWindow(int windowID)
        {
            ...
            if (CanOverwrite && GUILayout.Button("Save"))
            {
                ...
                _toSave.SaveToFile(KSPUtil.ApplicationRootPath + "/GameData/LRTR/KCT/presets/" + _toSave.ShortName+".cfg");
        ...
        private static void ShowSettings()
        {
            ...
            _autoStockAlarms = KCTGameStates.Settings.AutoStockAlarms;
