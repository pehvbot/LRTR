...
namespace KerbalConstructionTime
{
    ...
    internal class InstallChecker : MonoBehaviour
    {
        ...
        private const string _folderName = "LRTR";
        ...
        protected void Start()
        {
            ...
            if (assemblies.Any())
            {
                ...
                (
                    ...
                    _modName + " has been installed incorrectly and will not function properly. KCT is now integrated into LRTR which means that installing it as a separate mod is no longer allowed.\n\nIncorrect path(s):\n" + string.Join("\n", badPaths.ToArray()),
                    "OK",
                    false,
                    HighLogic.UISkin
                );
