...
namespace LRTR
{
    ...
    public class MaintenanceHandler : ScenarioModule
    {
        ...
        {
            Profiler.BeginSample("LRTRMaintenance UpdateKCTRates");
        ...
        {
            Profiler.BeginSample("LRTRMaintenance UpdateUpkeep");
            ...
            NautTotalUpkeep = 0d;
            double perNaut = nautYearlyUpkeep * (1d / Config.daysPerYear);
            int nautCount = 0;
        ...
        public void Update()
        {
            ...
            {
                double cost = -timePassed * ((TotalUpkeep + Settings.maintenanceOffset) * (1d / (Config.hoursPerDay * 3600)));
            ...
            else
            {
                ...
                nextUpdate = time + Math.Min(3600 * Config.hoursPerDay, UpdateInterval * TimeWarp.CurrentRate / 100f);
            }
        }
        ...
        {
            _maintenanceCostMult = HighLogic.CurrentGame.Parameters.CustomParams<LRTRSettings>().MaintenanceCostMult;
        }
        ...
        private void EnsureFacilityLvlCostsLoaded()
        {
            if (_facilityLevelCosts.Count == 0)
            {
                ...
                Debug.Log($"[LRTR] Updated facilityLevelsCosts, count: {_facilityLevelCosts.Count}");
            }
        }
